"""
Layer Normalization Experiment - Testing if LayerNorm before tanh prevents saturation
...
for _path in ['/content/layernorm_experiment',
              os.path.join(os.path.dirname(os.path.abspath(__file__)), 'layernorm_experiment')]:
...
try:
    ...
    print("DEBUG: layernorm_experiment exists:", os.path.exists('/content/layernorm_experiment'))
    if os.path.exists('/content/layernorm_experiment'):
        print("DEBUG: layernorm_experiment contents:", os.listdir('/content/layernorm_experiment'))
    raise
...
def run_all_experiments():
    """Run all 16 experiments with LayerNorm actor."""
    print("="*70)
    print("LAYER NORMALIZATION EXPERIMENT")
