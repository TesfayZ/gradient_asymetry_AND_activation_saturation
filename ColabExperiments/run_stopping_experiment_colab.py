"""
Colab Stopping Experiment - Complete (All 16 experiments)
...
# Add stopping_experiment_run to path - Colab environment
for _path in ['/content/stopping_experiment_run',
              os.path.join(os.path.dirname(os.path.abspath(__file__)), 'stopping_experiment_run')]:
...
try:
    ...
    print("DEBUG: stopping_experiment_run exists:", os.path.exists('/content/stopping_experiment_run'))
    if os.path.exists('/content/stopping_experiment_run'):
        print("DEBUG: stopping_experiment_run contents:", os.listdir('/content/stopping_experiment_run'))
    raise
...
def get_experiment_key(actor_lr, critic_lr, run=0):
    return f'actor_{actor_lr}_critic_{critic_lr}_run_{run}'
...
def run_single_experiment(actor_lr, critic_lr, run=0):
    ...
    print(f"\n{'='*60}")
    print(f"Experiment: actor_lr={actor_lr}, critic_lr={critic_lr}")
    print(f"{'='*60}")
...
def run_all_experiments():
    ...
    print("="*70)
    print("STOPPING EXPERIMENT - Complete (All 16 experiments)")
    print("="*70)
